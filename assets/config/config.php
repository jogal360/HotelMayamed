<?php
  ...
  */
  ...
  DEFINE('SEM_VER_LUN1','04-07');
  DEFINE('SEM_VER_MAR1','05-07');
  DEFINE('SEM_VER_MIE1','06-07');
  DEFINE('SEM_VER_JUE1','07-07');
  DEFINE('SEM_VER_VIE2','08-07');
  DEFINE('SEM_VER_SAB2','09-07');
  DEFINE('SEM_VER_DOM2','10-07');
  DEFINE('SEM_VER_LUN2','11-07');
  DEFINE('SEM_VER_MAR2','12-07');
  DEFINE('SEM_VER_MIE2','13-07');
  DEFINE('SEM_VER_JUE2','14-07');
  DEFINE('SEM_VER_VIE3','15-07');
  DEFINE('SEM_VER_SAB3','16-07');
  DEFINE('SEM_VER_DOM3','17-07');
  DEFINE('SEM_VER_LUN3','18-07');
  DEFINE('SEM_VER_MAR3','19-07');
  DEFINE('SEM_VER_MIE3','20-07');
  DEFINE('SEM_VER_JUE3','21-07');
  DEFINE('SEM_VER_VIE4','22-07');
  DEFINE('SEM_VER_SAB4','23-07');
  DEFINE('SEM_VER_DOM4','24-07');
  DEFINE('SEM_VER_LUN4','25-07');
  DEFINE('SEM_VER_MAR4','26-07');
  DEFINE('SEM_VER_MIE4','27-07');
  DEFINE('SEM_VER_JUE4','28-07');
  ...
  DEFINE('SEM_INV_LUN1','05-12');
  DEFINE('SEM_INV_MAR1','06-12');
  DEFINE('SEM_INV_MIE1','07-12');
  DEFINE('SEM_INV_JUE2','08-12');
  DEFINE('SEM_INV_VIE2','09-12');
  DEFINE('SEM_INV_SAB2','10-12');
  DEFINE('SEM_INV_DOM2','11-12');
  DEFINE('SEM_INV_LUN2','12-12');
  DEFINE('SEM_INV_MAR2','13-12');
  DEFINE('SEM_INV_MIE2','14-12');
  DEFINE('SEM_INV_JUE3','15-12');
  DEFINE('SEM_INV_VIE3','16-12');
  DEFINE('SEM_INV_SAB3','17-12');
  DEFINE('SEM_INV_DOM3','18-12');
  DEFINE('SEM_INV_LUN3','19-12');
  DEFINE('SEM_INV_MAR3','20-12');
  DEFINE('SEM_INV_MIE3','21-12');
  DEFINE('SEM_INV_JUE4','22-12');
  DEFINE('SEM_INV_VIE4','23-12');
  DEFINE('SEM_INV_SAB4','24-12');
  DEFINE('SEM_INV_DOM4','25-12');
  DEFINE('SEM_INV_LUN4','26-12');
  DEFINE('SEM_INV_MAR4','27-12');
  DEFINE('SEM_INV_MIE4','28-12');
